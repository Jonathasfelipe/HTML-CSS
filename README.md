...
<head>
  ...
  <title>Estudos de HTML e CSS - Jonathas Felipe</title>
  <link rel="shortcut icon" href="bleach logo icon.png" type="image/x-icon">
  <style>
    body {
    ...
    header {
      background: linear-gradient(to right, #ffffffcc, #e0e0e0cc);
      padding: 2rem 1rem;
      text-align: center;
    ...
    footer {
      text-align: center;
      padding: 1rem;
      background: linear-gradient(to right, #e0e0e0cc, #ffffffcc);
      color: #000000;
      font-size: 0.9rem;
      box-shadow: 0 -2px 8px rgba(0,0,0,0.1);
      backdrop-filter: blur(5px);
